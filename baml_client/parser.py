...
class LlmResponseParser:
    ...
    def GetAIMove(
        ...
        result = self.__options.merge_options(baml_options).parse_response(function_name="GetAIMove", llm_response=llm_response, mode="request")
        return typing.cast(types.AIMove, result)
...
class LlmStreamParser:
    ...
    def GetAIMove(
        ...
        result = self.__options.merge_options(baml_options).parse_response(function_name="GetAIMove", llm_response=llm_response, mode="stream")
        return typing.cast(stream_types.AIMove, result)
