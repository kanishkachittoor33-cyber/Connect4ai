...
class BamlSyncClient:
    ...
    def GetAIMove(self, gameState: types.GameState,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="GetAIMove", args={
                "gameState": gameState,
            })
...
class BamlStreamClient:
    ...
    def GetAIMove(self, gameState: types.GameState,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.AIMove, types.AIMove]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="GetAIMove", args={
            "gameState": gameState,
        })
        return baml_py.BamlSyncStream[stream_types.AIMove, types.AIMove](
          result,
...
class BamlHttpRequestClient:
    ...
    def GetAIMove(self, gameState: types.GameState,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="GetAIMove", args={
            "gameState": gameState,
        }, mode="request")
        return result
